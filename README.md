...
### 株式会社PR TIMES
  ...
  * PR TIMES事業ユニット CTO（2026/04〜）
  * PR TIMES事業ユニット 第一開発部長CTO（2025/01〜2026/04）
...
* 変わらないサービスから、変えていけるサービスへ ──「そのままにしない」を続けてきた4年半 | PR TIMES 開発者ブログ https://developers.prtimes.jp/2025/12/24/cto_activities_2025/
